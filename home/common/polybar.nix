    ...
    settings =
      ...
      in
      {
        ...
        "bar/main" = {
          ...
          "font-1" = "Font Awesome 7 Free,Font Awesome 7 Free Regular:style=Regular:size=10.5;2";
          "font-2" = "Font Awesome 7 Brands,Font Awesome 7 Brands Regular:style=Regular:size=10.5;2";
          "font-3" = "Font Awesome 7 Free,Font Awesome 7 Free Solid:style=Solid:size=10.5;2";

          "modules-left" = "i3 xwindow";
          "modules-right" = "xkeyboard pulseaudio backlight filesystem memory cpu battery wlan eth date tray";
